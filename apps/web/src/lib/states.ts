...
export const EVENT_KIND: Record<EventKind, StateStyle & { short: string }> = {
  INJECTION_REQUEST: { label: "Injection requested", short: "REQ", tone: "info", description: "Scenario asked the adapter to inject an effect" },
  INJECTION_APPLIED: { label: "Injection applied", short: "INJ", tone: "info", description: "Adapter confirmed the effect is active" },
  INJECTION_REJECTED: { label: "Injection rejected", short: "REJ", tone: "bad", description: "Adapter could not apply the effect" },
  INJECTION_CLEARED: { label: "Injection cleared", short: "CLR", tone: "dim", description: "Effect removed" },
  OBSERVED_EFFECT: { label: "Observed effect", short: "OBS", tone: "warn", description: "Component state change observed in the target" },
  SYSTEM_RESPONSE: { label: "System response", short: "RSP", tone: "info", description: "Autonomous reaction of the target" },
  RECOVERY: { label: "Recovery", short: "RCV", tone: "ok", description: "Component returned to a healthy state" },
  EXPECTATION_RESULT: { label: "Expectation", short: "EXP", tone: "info", description: "Declared expectation checked against observations" },
  ASSERTION_RESULT: { label: "Assertion", short: "AST", tone: "info", description: "Assertion evaluated" },
