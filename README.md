...
Resilient UAS Lab injects the *effects* of degradation into a simulated unmanned
aircraft system, observes how the autonomy detects, contains and recovers from them,
and turns the observation into reproducible metrics, a transparent score and a
canonical report. Scenarios are declarative YAML, targets are reached through a generic
adapter contract, and every run can be replayed, compared and gated in CI.
...
*Mission Control at T+01:13 of the `compound-degradation` demo on the mock adapter: three
active injections, the blast radius stopped at the trust boundary, the flight core
untouched, mean time to recovery 4.9 s. Captured from the Docker Compose stack.*
...
7. [The resilience model](#7-the-resilience-model)
8. [Scenarios](#8-scenarios)
9. [Fault catalogue](#9-fault-catalogue)
10. [Metrics, scoring and hard gates](#10-metrics-scoring-and-hard-gates)
11. [Reports, replay and comparison](#11-reports-replay-and-comparison)
12. [Adapters](#12-adapters)
13. [Mission Control](#13-mission-control)
14. [Command line interface](#14-command-line-interface)
15. [API](#15-api)
16. [Resilience regression in CI](#16-resilience-regression-in-ci)
17. [Deployment and security](#17-deployment-and-security)
18. [Observability](#18-observability)
19. [Development and testing](#19-development-and-testing)
20. [Verification status of this release](#20-verification-status-of-this-release)
21. [Repository layout, roadmap and documentation](#21-repository-layout-roadmap-and-documentation)
22. [Contributing, security, licence and references](#22-contributing-security-licence-and-references)
...
## 10. Metrics, scoring and hard gates
...
## 11. Reports, replay and comparison
...
## 16. Resilience regression in CI
...
## 20. Verification status of this release
...
## 21. Repository layout, roadmap and documentation
...
## 22. Contributing, security, licence and references
